...
//        replacingInMaps();
    ...
    private static void workingWithMaps() {
        ...
        System.out.println(favouriteMovies.getOrDefault("Maribel", "Chatter"));
    }
    ...
    private static void computingOnMaps() {
        ...
        friendsToMovies.computeIfPresent("Raphael", (s, strings) -> new ArrayList<>()).add("Daniel");
        System.out.println(friendsToMovies);
